  ...
  return (
   ...
   <div class="relative h-full w-full bg-slate-900"><div class="absolute bottom-0 left-[-20%] right-0 top-[-10%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div><div class="absolute bottom-0 right-[-20%] top-[-10%] h-[500px] w-[500px] rounded-full bg-[radial-gradient(circle_farthest-side,rgba(255,0,182,.15),rgba(255,255,255,0))]"></div>
    <div className='min-h-screen w-full bg-black'>
      <h1 className="font-bold text-5xl text-center text-white py-5  ">Events</h1>
    <div className={`bg-black  items-center flex justify-center pb-5`}>
      <div className="  flex mb-9  flex-wrap gap-10  justify-center">
        ...
        eventsToShow.map((event) => (
          ...
          return  <div key={index} className="col-span-12 sm:col-span-4 h-[350px] w-[300px] bg-gray-200 rounded-lg animate-pulse">
